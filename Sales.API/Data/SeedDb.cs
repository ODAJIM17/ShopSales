...
namespace Sales.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Jimmy", "Davila", "davila@yopmail.com", "7863670527", "8788 NW 141 Terrace Miami Lakes FL", "JimmyDavila.jpeg", UserType.Admin);
        ...
        private async Task<User> CheckUserAsync(string document, string firstName, string lastName, string email, 
            string phone, string address, string image, UserType userType)
        {
